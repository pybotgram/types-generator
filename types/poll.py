...
class Poll(Object):
    ...
    Parameters:
        ...
        options (List of :obj:`~pybotgram.types.PollOption`):
            List of poll options.

        total_voter_count (:py:obj:`int`):
            Total number of users that voted in the poll.

        is_closed (:py:obj:`bool`):
