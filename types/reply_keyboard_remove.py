...
class ReplyKeyboardRemove(Object):
    ...
    Parameters:
        remove_keyboard (:py:obj:`bool`):
            Requests clients to remove the custom keyboard (user will
            not be able to summon this keyboard; if you want to hide
        ...
        selective (:py:obj:`bool`, *optional*):
            ...
            original message.  Example: A user votes in a poll, bot
            returns confirmation message in reply to the vote and
            removes the keyboard for that user, while still showing
            the keyboard with poll options to users who haven't voted
            yet.
    """
